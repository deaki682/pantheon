...
| 11 | **Delphi ruleset, full window**: her exact frozen live rules (65d momentum, top-10 EW, 20-day-MA exit via `ExitRules`, weekly, 5% cash floor) on quarterly PIT top-119 universes, 1999→2026 — is her edge her rules or her era? Two frozen ablations (no-exit, monthly) attribute the MA exit and cadence | Whether the MA exit + weekly cadence (the parts gauntlet_v1 never tested) justify continued live capital, and the pending universe-switch decision; REFUTED carries a pre-committed retire-or-demote consequence | Quarterly top-119 universes 1999→2026 (extend #4's method via DAILY bulk), SEP bars for the member union, SPY closeadj | None — prereg committed 2026-07-04 ([prereg](lab_prereg_delphi_ruleset_fullwindow.md)), engine ready (ExitRules, addendum 3); needs one data-pull session | **High — next study up** |
