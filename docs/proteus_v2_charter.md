# Proteus v2 — Charter v2.1

**Status: RATIFIED IN FULL — operator directive, 2026-07-13.** Drafted
2026-07-13 by Proteus under the amendment process this document defines
(art. 29); reviewed and ratified the same day, unedited, by the
operator. This is the governing charter. The 2026-07-11 charter is
archived at `docs/proteus_v2_charter_2026-07-11_SUPERSEDED.md` (the
past stands). Per art. 28b, `tests/test_proteus_floor.py` is
OPERATOR-OWNED as of this ratification, and the bootstrap's
test-ownership grant is amended accordingly in the ratifying commit.
