...
Mark 2026-07-14 ~14:15 ET (live): equity $4,459.16 (-0.91% vs basis; SPY +0.17%
from the same 07-10 entry, spy_entry 751.31). Cash $449.94 (~10%). No filings on
any held name since entry (EDGAR re-checked 07-14 ~14:15 ET; latest ZVRA filing
is a pre-entry Form 144 dated 07-08) — no kill evaluable yet. Worst wobble ZVRA
−6.5%; a drawdown is never an exit. Broker reconcile clean, no open oracle orders.
