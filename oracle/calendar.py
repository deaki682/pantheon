...
def _to_naive_utc(dt: datetime) -> datetime:
    """Normalize a datetime to naive UTC so aware and naive values compare.

    Timestamps in cadence files come from multiple writers — some use
    datetime.utcnow() (naive), others datetime.now(timezone.utc) (aware) —
    and subtracting one from the other raises TypeError.
    """
