"""gauntlet_v5_newfundamentals phase 1: SF1 ARQ panel pull (expanded columns
for cash-based OP / abnormal R&D / fundamental momentum + gross-prof reference).
PAPER ONLY. Usage: python3 run_gauntlet_v5_pull.py SCRATCH"""
...
# cash_op: revenue,cor,sgna,rnd + working-capital levels receivables,inventory,
# payables,deferredrev + assets. delta_rnd: rnd,assets. fund_mom: eps,netinc,
# equity. gross_prof (reference): gp,assets.
COLS = ("ticker,datekey,calendardate,assets,equity,netinc,eps,revenue,cor,"
        "sgna,rnd,gp,receivables,inventory,payables,deferredrev")
rows, part, total = [], 0, 0
